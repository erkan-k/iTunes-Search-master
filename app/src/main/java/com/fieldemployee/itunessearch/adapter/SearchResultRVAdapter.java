package com.fieldemployee.itunessearch.adapter;
...
public class SearchResultRVAdapter extends RecyclerView.Adapter<SearchResultRVAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.music_item_trackPrice_text)
        TextView music_item_trackPrice_text;
        ...
        void bindData(ResultModel resultModel) {
            ...
            music_item_trackPrice_text.setText("$"+resultModel.trackPrice());
